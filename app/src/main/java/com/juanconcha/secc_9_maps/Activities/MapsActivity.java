...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in Santiago").draggable(true));

        CameraPosition camera = new CameraPosition.Builder()
                .target(sydney)
                .zoom(15) //limit --> 21 level street
                .bearing(0)//orientation camera de 0 - 365º
                .tilt(45)//inclination camera
                .build();
       ...
       // mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        mMap.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragEnd(Marker marker) {
                Toast.makeText(MapsActivity.this,"Marker dragged on: \n"+
